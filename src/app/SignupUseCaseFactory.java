...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUsersUseCase(viewManagerModel, signupViewModel, clearViewModel, clearUserDataAccessObject);
    ...
    private static ClearController createClearUsersUseCase(ViewManagerModel viewManagerModel, SignupViewModel signupViewModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface userDataAccessObject) throws IOException {
